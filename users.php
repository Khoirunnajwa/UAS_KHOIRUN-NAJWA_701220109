						...
						<table id="user" class="table table-striped table-bordered table-hover">
							<thead>
								<tr style="font-size: 13px;">
									...
									<th style="vertical-align: middle;"><center>No Telepon</center></th>
									<th style="vertical-align: middle;"><center>Umur</center></th>
									<th style="vertical-align: middle;"><center>Alamat</center></th>
							...
							<tbody>
								<tr>
									...
									<td style="vertical-align: middle;"><?php echo $data['no_telepon']; ?></td>
									<td style="vertical-align: middle;"><?php echo $data['umur']; ?></td>
