<?php
	...
	$id_surat = isset($_REQUEST['id']) ? $_REQUEST['id'] : 0;
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						...
						<a href="index.php?page=tambah_disposisi&id=<?php echo $data['id_disp']?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Disposisi</a>
