	<?php
		...
		if (isset($_REQUEST['edit'])) {
			...
			//jika mengubah foto
				$query2 	  	= "UPDATE user SET username='$username', fullname='$fullname', level='$level', jenis_kelamin='$jenis_kelamin', no_telepon='$no_telepon', umur='$umur', alamat='$alamat', foto='$foto' WHERE id='$_GET[id]'";
			...
			//jika tidak mengubah foto
				$query3 	= "UPDATE user SET username='$username', fullname='$fullname', level='$level', jenis_kelamin='$jenis_kelamin', no_telepon='$no_telepon', umur='$umur', alamat='$alamat' WHERE id='$_GET[id]'";
					...
					<div class="x_content">
						...
						<form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="no_telepon" class="form-control col-md-7 col-xs-12" required="required" value="<?php echo $data['no_telepon'] ?>">
								</div>
							</div>
							<div class="item form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">Umur<span class="required">&nbsp; :</span></label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="number" name="umur" class="form-control col-md-7 col-xs-12" required="required" value="<?php echo $data['umur'] ?>">
								</div>
							</div>
							<div class="item form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">Alamat<span class="required">&nbsp; :</span></label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="alamat" class="form-control col-md-7 col-xs-12" required="required" value="<?php echo $data['alamat'] ?>">
								</div>
							</div>
							<div class="item form-group">
